...
router.get('/handle/:handle',(req,res) =>{
    ...
    .then(profile => {
        if(!profile){
            errors.noprofile = "Theres is no profile for this user";
...
//Skils- Split into array
    ...
    if(req.body.linkedin) profileFields.social.linkedin = req.body.youtube;
...
(req,res) => 
{
    ...
    .then(profile =>
    {
        const newEdu = 
        {
            ...
            fieldofstudy: req.body.fielddofstudi,
            from: req.body.from,
            to: req.body.to,
            current: req.body.current,
            description: req.body.description
